...
#     tsne_dg = tsne.fit_transform(DG)
#     tsne_ca3 = tsne.fit_transform(CA3)
#     tsne_ca1 = tsne.fit_transform(CA1)
# =============================================================================
...
#     ax.scatter(tsne_dg[:,0],tsne_dg[:,1],tsne_dg[:,2], c=colors, marker="x")
#     ax.scatter(tsne_ca3[:,0], tsne_ca3[:,1],tsne_ca3[:,2], c=colors, marker="o")
